...
public class ConsumidorTempoReal {
        ...
        try {
            ...
            clienteMqtt.setCallback(new MqttCallback() {
                ...
                public void messageArrived(String topico, MqttMessage mensagem) throws Exception {
                    System.out.println("Dado em tempo real recebido: " + new String(mensagem.getPayload()));
                }
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            switch (opcao) {
                case 1: topicoEscolhido = "gateway/dados_processados/#"; break;
                case 2: topicoEscolhido = "gateway/dados_processados/norte"; break;
                case 3: topicoEscolhido = "gateway/dados_processados/sul"; break;
                case 4: topicoEscolhido = "gateway/dados_processados/leste"; break;
                case 5: topicoEscolhido = "gateway/dados_processados/oeste"; break;
                default:
